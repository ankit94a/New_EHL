...
export class AttributeComponent {
  ...
  constructor(private dialogService: BISMatDialogService, private apiService: ApiService, private toastr: ToastrService) {
    this.getWing();
  }
  ...
  delete(row) {
    ...
    this.dialogService.confirmDialog('Are you sure you want to delete this Attribute?').subscribe((res) => {
      if (res) {
        this.apiService.postWithHeader(`attribute/delete`, deleteAttr)
          .subscribe({
            next: (res) => {
